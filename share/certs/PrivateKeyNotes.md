...
unlocked to sign the Titcoin-Qt.app bundle.
...
allowing somebody to distribute a Titcoin-Qt.app or bitcoin-qt-setup.exe with a valid
...
that the titcoin-qt.exe file inside the installer had not been tampered with.
